...
class TestSpecS1_HealthEndpoint:
...
def seed_engine():
    """Connect to the real seed database for integration smoke tests."""
    import os
    db_path = os.path.expanduser("~/Projects/peerpedia/peerpedia.db")
...
class TestSpecS4_SeedDataAccessible:
