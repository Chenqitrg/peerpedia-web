...
vi.mock('../../api/articles', () => ({
  getArticle: vi.fn().mockResolvedValue({
    ...
    fork_count: 2,
    forked_from: null,
    commit_count: 3,    score: { originality: 4, rigor: 5, completeness: 4, pedagogy: 3, impact: 4 },
...
describe('ArticlePage', () => {
  ...
  it('renders Merge button when article is a fork (has forked_from)', async () => {
    ...
    getArticle.mockResolvedValueOnce({
      ...
      commit_count: 1,      score: { originality: 4, rigor: 4, completeness: 3, pedagogy: 3, impact: 3 },
      sink_eta: null,
      days_remaining: null,
      sink_duration_days: 30,
      review_count: 0,
