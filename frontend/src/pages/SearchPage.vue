...
const isLocalMode = computed(() =>
  route.query.mode === 'local' || tauri.isTauri.value || tauri.isBrowserLocal.value
)
  ...
  <div class="search-page animate-fade-in">
    <div class="flex items-center gap-3 mb-6">
      ...
      <span
        ...
        :class="searchScope === 'search_local' ? 'bg-[#21262d] text-ink-muted/60' : 'bg-accent/15 text-accent'"
      >
        {{ searchScope === 'search_local' ? 'Local' : 'Network' }}
      </span>
    </div>
